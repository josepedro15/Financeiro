...
export const useSubscription = () => {
  ...
  const incrementUsage = async (
    ...
    try {
      ...
      // Recarregar dados após incrementar
  ...
  const upgradePlan = async (newPlan: 'starter' | 'business') => {
    ...
    try {
      const limits = {
        starter: { monthly_transaction_limit: 1000, user_limit: 1, client_limit: 50 },
        business: { monthly_transaction_limit: null, user_limit: 3, client_limit: null }
      };
