-- Script SIMPLIFICADO para criar sistema de assinaturas
-- Execute este script no Supabase SQL Editor
-- Sem dependências de organização

SELECT '=== INICIANDO CRIAÇÃO SISTEMA ASSINATURAS SIMPLES ===' as status;
...
-- 4. Criar políticas RLS SIMPLES para subscriptions (só próprio usuário)
...
-- 6. Criar função para verificar limites de plano (VERSÃO CORRIGIDA COM TRIAL)
...
-- 11. Testes finais
SELECT '=== TESTANDO SISTEMA SIMPLIFICADO ===' as info;
...
-- Simular criação de novo usuário (teste)
SELECT 
    'TESTE NOVO USUÁRIO (TRIAL):' as teste,
    allowed,
    current_count,
    limit_count,
    plan_type
...
SELECT '=== ✅ SISTEMA SIMPLIFICADO CRIADO COM SUCESSO ===' as final_status;
