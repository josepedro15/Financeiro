-- Script para inserir dados de abril 2025 (dias 1, 2 e 3)
-- Execute este script no Supabase SQL Editor
-- NÃO APAGA NADA EXISTENTE - APENAS ADICIONA

-- 4/1/2025 - R$ 904.24 (17 transações)
...
('2dc520e3-5f19-4dfe-838b-1aca7238ae36', '2025-04-01', 'WEMERSON FERNANDO', 40.00, 'income', 'Conta PJ', NOW(), NOW()),
('2dc520e3-5f19-4dfe-838b-1aca7238ae36', '2025-04-01', 'JOCILENE SANTOS', 75.91, 'income', 'Conta Checkout', NOW(), NOW()),
...
('2dc520e3-5f19-4dfe-838b-1aca7238ae36', '2025-04-01', 'DANIEL CAMARA', 90.00, 'income', 'Conta PJ', NOW(), NOW()),
('2dc520e3-5f19-4dfe-838b-1aca7238ae36', '2025-04-01', 'TAIANE DA SILVA', 39.95, 'income', 'Conta PJ', NOW(), NOW()),
('2dc520e3-5f19-4dfe-838b-1aca7238ae36', '2025-04-01', 'JAQUELINE GOLDSCHIMIDT', 76.00, 'income', 'Conta PJ', NOW(), NOW()),
('2dc520e3-5f19-4dfe-838b-1aca7238ae36', '2025-04-01', 'ADRIANA BERTONI', 39.95, 'income', 'Conta PJ', NOW(), NOW());

-- 4/2/2025 - R$ 1,111.88 (25 transações)
INSERT INTO public.transactions (user_id, transaction_date, description, amount, transaction_type, account_name, created_at, updated_at) VALUES
...
-- 4/3/2025 - R$ 958.91 (19 transações)
INSERT INTO public.transactions (user_id, transaction_date, description, amount, transaction_type, account_name, created_at, updated_at) VALUES
...
('2dc520e3-5f19-4dfe-838b-1aca7238ae36', '2025-04-03', 'EDVANIA RODRIGUES', 75.91, 'income', 'Conta Checkout', NOW(), NOW()),
